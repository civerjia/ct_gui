...
if TYPE_CHECKING:   # editors only: the annotations below name it
    from ._link import ControllerLink
...
__all__ = [
    ...
    "ThreadingHTTPServer", "UART_STATUS_NAMES", "_BOARD_MON", "_BOARD_MON_LOCK",
    ...
    "_ORDER_LOCK", "_SINGLE_0X3A_TRUSTED", "_TPS_IOUT_LIMIT_REG", "_pushed_boards",
